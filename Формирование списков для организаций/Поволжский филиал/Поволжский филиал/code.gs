...
function transferV2(){
  ...
  let newSheet = SpreadsheetApp.openById("1ivbjlWqA1Rsw3-vpfJYJEMCOWqkI9BVQ7nh8jON6Kq4").getSheetByName("Оформление_V.2");
  ...
  range = range.filter(function(e){ return e[14] != "" && e[11].indexOf("ИЗИ")>=0; })
               ...
               .forEach(function(item){newSheet.getRange(getPosV2(item[1], isiSheetId), 1, 1, 15).setValues([item]); })
}
