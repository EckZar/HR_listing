...
function checkV2(){
  ...
  if(cell.indexOf("M">=0))
  {
    ...
    let main = SpreadsheetApp.openById("19IFgT-pnmnlgNYej59IS5Vh31zB0U1bF7WEMZya4CVk").getSheetByName("Оформление_V.2");
...
function checkByUUIDV2(){
  ...
  let mainSheet = SpreadsheetApp.openById("19IFgT-pnmnlgNYej59IS5Vh31zB0U1bF7WEMZya4CVk").getSheetByName("Оформление_V.2");
